...
Check into the https://docs.openshift.com/acs/3.66/configuration/enable-alert-data-retention.html[official documentation] the different configuration tweaks that you can do in the RH ACS cluster:

image::multicluster/03_multi.png[ACS Multi 3, 800]
