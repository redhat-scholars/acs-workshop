...
You can install the roxctl CLI to interact with Red Hat Advanced Cluster Security for Kubernetes from a command-line interface. 

You can install roxctl on Linux, Windows, or macOS.

Follow the https://docs.openshift.com/acs/3.70/cli/getting-started-cli.html#install-roxctl-cli-binary[guide] for installing roxtctl in your system
...
image::cli/roxctl1.png[ACS ROXCTL 1, 600]
