...
image::violations/01-violations.png[Violations 1, 800]
...
image::violations/02-violations.png[Violations 2, 600]
...
* Click on a Violation of the Red hat Package Manager in Image policy. Again, you may have to look or search (filter) for it. The violation details appear on the right.

image::violations/03-violations.png[Violations 3, 800]
...
image::violations/04-violations.png[Violations 4, 700]
