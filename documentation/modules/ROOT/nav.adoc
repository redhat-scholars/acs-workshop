...
* xref:11-integrations.adoc#integrate_with_internal_openshift_registry[Installing ACS DevSecOps Pipeline]
...
** xref:14-apicli.adoc#install_devsecops_pipelines[Installing ACS DevSecOps Pipeline]
